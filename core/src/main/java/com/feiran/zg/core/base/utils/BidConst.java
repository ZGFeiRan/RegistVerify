...
public class BidConst {
    ...
    // 系统默认超级管理员的用户名和密码
    public static final String DEFUALT_ADMIN_NAME = "admin";
    public static final String DEFUALT_ADMIN_PASSWROD = "1111";


    // 发送手机验证码的时间间隔
    public static final long SEND_VERIFYCODE_INTERVAL = 5;// 单位是秒

    // 手机验证码的有效期是180秒
    public static final long VERIFYCODE_VALID_TIME = 180;// 单位是秒,即三分钟

    // 邮件的有效天数是5天
    public static final long VERIFYEMAIL_VALID_DAY = 5;// 单位是天

    // 用户借款是最低风控分数
    public static final long CREDIT_BORROW_SCORE = 30;

    //==========================================================
    /**
     * 存储图片的公共文件夹地址
     */
    public static final String PUBLIC_IMG_SHARE_PATH="G:\\A--Disk\\publicImageFile";
