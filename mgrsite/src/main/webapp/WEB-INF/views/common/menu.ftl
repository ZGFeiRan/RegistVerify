<ul id="menu" class="list-group">
	...
	<li class="list-group-item">
		<a href="javaScript:;" data-toggle="collapse" data-target="#permissionmanage_detail"><span>安全管理</span></a>
	...
	<li class="list-group-item">
		<a href="javaScript:;" data-toggle="collapse" data-target="#auditmanage_detail">
			<span>审核项目</span>
		</a>
	...
	<li class="list-group-item">
		<a href="javaScript:;" data-toggle="collapse" data-target="#systemmanage_detail">
			<span>平台管理</span>
		</a>
